...
import expenseWallet from '../assets/projects/expense-wallet.jpg';
import topMovies from '../assets/projects/top-250-movies.png';
import relationshipDashboard from "../assets/projects/relationship-dashboard.png";

export const projImg = {
  'ai-journal': aiJournaling,
  'chat-app': chatApp,
  'expense': expenseTracker,
  'expense-wallet': expenseWallet,
